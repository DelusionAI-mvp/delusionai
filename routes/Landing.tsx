...
export default function LandingPage() {
  ...
  return (
    <div className="page-base relative overflow-hidden">
      ...
      <div className="global-container pt-2 md:pt-4 flex flex-col items-center justify-center text-center">
        <div className="w-full space-y-6 md:space-y-8 relative z-10">
          <div className="flex flex-col items-center gap-3 md:gap-4 mb-2 md:mb-4">
            <Logo size={48} className="sm:size-[64px] text-brand-primary" />
            <div className="flex items-center justify-center gap-3 text-brand-primary font-medium uppercase tracking-[0.2em] sm:tracking-[0.4em] text-xs sm:text-sm">
              <div className="h-[1px] bg-brand-primary/30 w-8 sm:w-12"></div>
              Support
              <div className="h-[1px] bg-brand-primary/30 w-8 sm:w-12"></div>
            </div>
          </div>

          <h1 id="landing-hero-heading" style={{ width: '100%', maxWidth: '600px', height: 'auto', minHeight: '120px' }} className="text-4xl xs:text-5xl sm:text-6xl md:text-7xl lg:text-[5rem] font-display font-light leading-[1.05] tracking-tight uppercase relative text-text-base text-balance px-4 mx-auto flex flex-col justify-center">
        ...
        <p className="font-sans font-light text-sm sm:text-base text-text-muted max-w-lg mx-auto leading-[1.8] px-4 mt-2">
        ...
        <div className="pt-6 w-full px-4 md:px-0">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full border-t border-brand-primary/10 pt-6">
            {/* Box 1: Maya AI */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                We help you feel better through support from AI and your Peer connection.                </p>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-4 pt-1">
                <a href="https://www.linkedin.com/company/delusionai/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 cred-elevation flex items-center justify-center text-zinc-600 hover:text-brand-primary hover:border-brand-primary transition-all group">
                  <Linkedin size={16} className="group-hover:scale-110 transition-transform" />
                </a>
                <a href="https://www.instagram.com/delusionai.in?igsh=YTVvcGFkZWkzN3N3" target="_blank" rel="noopener noreferrer" className="w-10 h-10 cred-elevation flex items-center justify-center text-zinc-600 hover:text-brand-primary hover:border-brand-primary transition-all group">
                  <Instagram size={16} className="group-hover:scale-110 transition-transform" />
                </a>
                <a href="https://x.com/Delusion_Ai" target="_blank" rel="noopener noreferrer" className="w-10 h-10 cred-elevation flex items-center justify-center text-zinc-600 hover:text-brand-primary hover:border-brand-primary transition-all group">
